...
function printHelp() {
  process.stdout.write([
    "Usage: node scripts/explain-route-scope.js --message-type private --user-id 100000001 [--operation chat|execute|memory] [--table]",
    "       node scripts/explain-route-scope.js --message-type group --group-id 123456789 [--operation chat|execute|memory] [--table]",
    "",
