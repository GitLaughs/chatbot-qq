...
function runScenario(scenario) {
  ...
  try {
    ...
    savePendingCandidates({ workspace, scope: "group", scopeID: "1107099585", candidates });
    ...
    const applyResult = applyPendingCandidates({ workspace, selector: "all", appliedBy: "guard", scopeID: "1107099585" });
