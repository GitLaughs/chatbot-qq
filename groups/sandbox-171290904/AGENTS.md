# AGENTS.md - QQ 群沙箱 171290904

This workspace backs the QQ sandbox group `171290904`.

Rules:

- Only handle messages from QQ sandbox group `171290904`. Messages from any other group must never reach this workspace; if they do, respond with nothing and report a routing bug.
...
- Routing intent: this group is @-only. Explicit @ task messages use `gpt-5.5` with high reasoning.
